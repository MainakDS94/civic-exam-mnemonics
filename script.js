...
var NUMBERS = [
  ...
  { front: '6 ans',   back: 'Mandat du maire et du conseil municipal',                      memo: "6 ans comme les sénateurs → les deux élus locaux." },
...
var PEOPLE = [
  ...
  { front: 'Général de Gaulle',    dates: '1890–1970', back: 'Appel du 18 juin 1940. Libère la France (1944). Fonde la Ve République (1958). Instaure le suffrage universel direct (1962).', memo: 'De Gaulle = 18 juin 1940 + Ve République 1958 + suffrage universel 1962.' },
  { front: 'Jean Moulin',          dates: '1899–1943', back: 'Préfet devenu résistant. Unifie les mouvements de résistance intérieure. Arrêté par la Gestapo en 1943, meurt sans parler.', memo: 'Jean Moulin = le visage de la Résistance intérieure.' },
  ...
  { front: 'Jules Ferry',          dates: '1832–1893', back: "Père de l'école républicaine. Rend l'école gratuite (1881), laïque et obligatoire (1882).",                            memo: "Ferry = Gratuit + Laïque + Obligatoire." },
  { front: 'Victor Hugo',          dates: '1802–1885', back: "Écrivain romantique. Les Misérables, Notre-Dame de Paris. Milite pour les droits de l'homme.",                         memo: 'Hugo = Les Misérables + Notre-Dame de Paris.' },
  { front: 'Molière',              dates: '1622–1673', back: "Père de la comédie française. Le Malade imaginaire, L'Avare. Vrai nom : Jean-Baptiste Poquelin.",                      memo: 'Molière = comédie classique. Vrai nom : Jean-Baptiste Poquelin.' },
  { front: 'Albert Camus',         dates: '1913–1960', back: "Écrivain et philosophe. L'Étranger, La Peste. Courant de l'absurde. Prix Nobel de littérature 1957.",                  memo: "Camus = L'Étranger + l'absurde + Prix Nobel 1957." },
  { front: 'Auguste Rodin',        dates: '1840–1917', back: 'Sculpteur. Père de la sculpture moderne. Le Penseur, Le Baiser. Musée Rodin à Paris.',                                 memo: 'Rodin = Le Penseur. Père de la sculpture moderne.' },
  { front: 'Auguste Renoir',       dates: '1841–1919', back: 'Peintre impressionniste. Le Bal du moulin de la Galette. Chef de file du mouvement avec Monet.',                       memo: 'Renoir = impressionnisme + joie de vivre.' },
  { front: 'Édith Piaf',           dates: '1915–1963', back: 'Chanteuse, icône de la chanson française. La Vie en rose, Non je ne regrette rien.',                                   memo: 'Piaf = La Vie en rose. Le petit moineau de Paris.' },
  { front: "Jeanne d'Arc",         dates: '1412–1431', back: "Héroïne nationale. Victoire contre les Anglais à Orléans (1429). Brûlée vive à Rouen. Canonisée en 1920.",            memo: 'Jeanne = épée + bûcher + Orléans. La première résistante de France.' },
  { front: 'Olympe de Gouges',     dates: '1748–1793', back: "Pionnière du féminisme. Déclaration des droits de la femme et de la citoyenne (1791). Guillotinée en 1793.",           memo: 'Gouges = 1791 = droits des femmes. A réécrit la DDHC au féminin.' },
  { front: 'Marie Curie',          dates: '1867–1934', back: 'Physicienne et chimiste. Seule personne à avoir deux prix Nobel : physique (1903) et chimie (1911). Née en Pologne, naturalisée française.', memo: 'Curie = 2 Nobel dans 2 disciplines. La seule au monde.' },
  { front: 'Simone de Beauvoir',   dates: '1908–1986', back: "Philosophe et écrivaine féministe. Le Deuxième Sexe (1949). « On ne naît pas femme, on le devient. » Prix Goncourt (1954).", memo: "Beauvoir = Le Deuxième Sexe. Beau-voir = voir les inégalités." },
  { front: 'Simone Veil',          dates: '1927–2017', back: "Ministre de la Santé. Rescapée de la Shoah. Loi sur l'IVG (avortement légal) en 1975. Panthéon en 2018.",             memo: 'Veil = loi IVG 1975 + Shoah + Panthéon 2018.' },
  { front: 'Marguerite Yourcenar', dates: '1903–1987', back: "Écrivaine. Première femme élue à l'Académie française (1980). Mémoires d'Hadrien.",                                   memo: "Yourcenar = 1980 = 1ère femme à l'Académie française." },
  { front: 'Gisèle Halimi',        dates: '1927–2020', back: "Avocate et militante féministe. Cofonde Choisir (1971) avec Simone de Beauvoir pour défendre le droit à l'avortement.", memo: "Halimi = avocate qui choisit les femmes. Combat pour l'IVG." },
  { front: 'George Sand',          dates: '1804–1876', back: "Écrivaine pionnière (Aurore Dupin). Signe sous un prénom masculin pour être prise au sérieux. La Mare au diable, Indiana.", memo: 'George Sand = femme qui écrit sous un nom masculin pour être libre.' }
];
...
/* ════════════════════════════════════════
   ACTIONS — attached via addEventListener, not onclick
════════════════════════════════════════ */
...
/* ════════════════════════════════════════
   INIT — wire up events after DOM is ready
════════════════════════════════════════ */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  ['dates', 'numbers', 'people'].forEach(function(id) {
    ...
    /* Prev / Next buttons — stop propagation so they don't also flip the card */
